                  ...
                  bloco_1: [
                     {
                        ...
                        imagem: 'https://cdn.awsli.com.br/1234/1234739/arquivos/banner-vertical-linha-led-09-03-2022.png',
                        link: '/oferta-da-semana?sort=mais_vendidos',
                     },
                     {
                        nome: 'Banner Lançamentos',
                        imagem: 'https://cdn.awsli.com.br/1234/1234739/arquivos/banner-vertical-lancamentos-09-03-2022.png',
	...
	const MiniBanners = {
	   ...
	   gerarObjeto(){
			 ...
			 let banners = [
				{
				   nome: 'Refletores LED',
				   imagem: 'https://cdn.awsli.com.br/1234/1234739/arquivos/mini-banner-refletores-led-03-06-2022.png',
				   link: '/refletores-holofotes-led?sort=mais_vendidos',
				},
				{
				   nome: 'Luminárias LED',
				   imagem: 'https://cdn.awsli.com.br/1234/1234739/arquivos/min-banner-luminarias-led-03-06-2022.png',
				   link: '/luminarias-plafons-led?sort=mais_vendidos',
				},
				{
				   nome: 'Ofertas da Semana',
				   imagem: 'https://cdn.awsli.com.br/1234/1234739/arquivos/mini-banner-ofertas-da-semana-03-06-2022.png',
				   link: '/oferta-da-semana?sort=mais_vendidos',
				}
			 ]
   ...
   iluminimCorporation(){
	...
	ordenacaoProdutosListagemMaisVendidos(){
   	...
   	reposicionarListagens(){
		...
		//MAIS VENDIDOS
		$(`
			a.titulo-categoria.borda-principal.cor-principal.vitrine-17540814+ul, 
			a.titulo-categoria.borda-principal.cor-principal.vitrine-17540814
